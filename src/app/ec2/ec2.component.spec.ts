...
import {RDSInstance} from '../rds/rds.component';
...
describe('Ec2Component', () => {
  ...
  // Todo get price response
  // it('should get cost for instance',
  //   (inject([AmazonWebService, XHRBackend],
  //     (amazonWebService: AmazonWebService, mockBackend: MockBackend) => {
  //       const mockResponse = [
  //         {
  ...
  //
  //       component.ngOnInit();
  //       const cost = component.getCost(3, component.ec2Instances[0]);
  //       console.log(cost);
  //   })));
});
